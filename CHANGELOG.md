...
### Changed
- **NPM Publishing**: Updated `publishConfig` to allow public access.
- **Documentation**: Refined project description in `package.json` and README files.
...
---
[3.0.2]: https://github.com/17media/node-logger/compare/v3.0.1...v3.0.2
